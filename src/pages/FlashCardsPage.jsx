...
export function FlashCardsPage() {
  ...
  function handleFlashCardInternalState(isCardShowingTitle) {
  ...
  async function handleFlashCardDelete(flashCardID) {
    try {
  ...
  function handleFlashCardEdit(flashCard) {
  ...
  async function handleFlashCardPersist(title, description) {
    if (createMode) {
      try {
        ...
        >
          ...
          <TabPanel className="max-w-3xl mx-auto">
            ...
            <div className="text-start my-6">
              <Button color="bg-indigo-700" onButtonClick={handleNewFlashCard}>
                New
              </Button>
            </div>
            <FlashCardForm
          ...
          <TabPanel>
            ...
            <div className="flex justify-center m-3">
              <Button color="bg-indigo-800" onButtonClick={handleShuffleCards}>
                Shuffle cards
              </Button>
            </div>
